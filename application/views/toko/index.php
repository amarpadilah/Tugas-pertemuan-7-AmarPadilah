    ...
    <div class="content container">
      <div aria-label="breadcrumb">
        <div class="breadcrumb  mt-3" style='text-align: center; display: flex; justify-content: center; flex-direction: column; align-items: center;'>
          <div class="ikon mb-2" style='font-size: 1.6rem; width: 3rem; height: 3rem; border: 2px solid #6315e0; display: flex; align-items: center; justify-content: center; border-radius: 50%; color: #35125d'>
            <i class='ti ti-pencil'></i>
          </div>
          <h4 style='margin: 0;'>FORM TRANSAKSI PEMBELIAN</h4>
        </div>
      </div>
      
      <div class="form">
        <form action="<?= base_url('toko/hasil'); ?>" method="POST">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="nomortelpon" name='nomortelpon' required>
            </div>
          </div>
          ...
          <button type="submit" class="btn btn-primary mt-4" style='display: flex; color: black; background-color: #40E0D0; width: 100%; justify-content: center;'>SIMPAN TRANSAKSI</button>
        </form>
      </div>
    </div>
